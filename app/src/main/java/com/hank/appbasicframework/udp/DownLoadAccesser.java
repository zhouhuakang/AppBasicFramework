...
public class DownLoadAccesser extends HttpAccessor {
    private static final String TAG = DownLoadAccesser.class.getName();
    private OnProgressListener mOnProgressListener;
    private int mInterval;


    public DownLoadAccesser(Context context) {
